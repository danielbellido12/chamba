...
<html lang="en">
  <head>
    ...
    <link href="assets/css/plugins/bootstrap-multiselect.css" rel="stylesheet" />
...
<form class="form-horizontal" role="form" id="formulario">
  <div class="form-group">
    <select multiple class="form-control nonfluid center-block" onchange="cargarCarteras()" name='cluster' id="sCluster">
    <?php
...
<div class="form-group">
<select multiple class="form-control nonfluid center-block" onchange="cargarCarteras()" name='tramo' id="sTramo">
          <?php
...
?>
  ...
  <script src="assets/js/plugins/bootstrap-multiselect.js"></script>
  <script src="assets/js/plugins/bootstrap-multiselect-collapsible-groups.js"></script>
