...
<html lang="en">
  <head>
    ...
    <link href="assets/css/plugins/bootstrap-select.css" rel="stylesheet">
...
?>
<form class="form-horizontal col-lg-6 col-lg-push-3" role="form" id="formulario">
  <div class="form-group">
    <select class="form-control selectpicker" multiple data-actions-box="true" onchange="cargarCarteras()" name='cluster' id="sCluster">
    <?php
    ...
    if( $stmt === false ) {
      ...
      //foreach ($stmt as $row) {
        ...
        {
          echo '<option selected value="'.$row['cluster'].'">'.$row['cluster'].'</option>';
        }
    ?>
      </select>
    </label>
...
<div class="form-group">
<select class="form-control selectpicker" multiple data-actions-box="true" onchange="cargarCarteras()" name='tramo' id="sTramo">
          <?php
...
if( $stmt === false ) {
  ...
  //foreach ($stmt as $row) {
    ...
    while ( $row = sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC))
    {
      echo '<option selected value="'.$row['tramo'].'">'.$row['tramo'].'</option>';
    }
?>
      </select>
    </div>
<div class="form-group">
<select class="form-control selectpicker" multiple data-actions-box="true" onchange="cargarCarteras()" name='mes' id="sMes">
          <?php
...
if( $stmt === false ) {
  ...
  //foreach ($stmt as $row) {
    ...
    while ( $row = sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC))
    {
      echo '<option selected value="'.$row['mes'].'">'.$row['mes'].'</option>';
    }
?>
      </select>
    </div>
...
<div class="form-group">
<select class="form-control selectpicker" multiple data-actions-box="true" onchange="cargarCarteras()" name='negocio' id="sNegocio">
          <?php
...
if( $stmt === false ) {
  ...
  //foreach ($stmt as $row) {
    ...
    while ( $row = sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC))
    {
      echo '<option selected value="'.$row['negocio'].'">'.$row['negocio'].'</option>';
    }
?>
      </select>
    </div>
...
<div class="form-group">
<select class="form-control selectpicker" multiple data-actions-box="true" onchange="cargarCarteras()" name='cerrada' id="sCerrada">
          <?php
...
if( $stmt === false ) {
  ...
  //foreach ($stmt as $row) {
    ...
    while ( $row = sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC))
    {
      echo '<option selected value="'.$row['Cerrada'].'">'.$row['Cerrada'].'</option>';
    }
?>
      </select>
    </div>
      ...
      <div class="container">
        <form action="metricas/call/cartera.php" action="post" id="display" class="row col-lg-6 col-lg-push-3">
            <?php

$sql = "SELECT distinct gestion from metricas";
